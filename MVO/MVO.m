...
function [Best_universe,Convergence_curve]=MVO(dim,net,inputs,targets)

[Max_time,ub,lb,N] = loadParameters();


% N=50; % Number of search agents
% Max_time=2;
% %pause;% Maximum numbef of iterations
% 
...
while Time<Max_time+1
    ...
    for i=1:size(Universes,1)
        ...
        Inflation_rates(1,i)=costALL(Universes(i,:), net, inputs, targets);
    ...
    if mod(Time,2)==0
      ...
      %  costALL2(Best_universe, net, inputs, targets);
    end
    Time=Time+1;
end
